...
- P2-06 的覆盖已闭合：四组重复采集，巡检域内均零漏拍，绝对锚点 P95 `1.670 / 0.630 /
  1.360 / 1.787 mm`；门限由带渲染记录的第 2、3、4 组推导，第 1 组只作旁证。全局 hard-cut 接缝的真值扣除跳变 P95 三组同为 pose-only `16`、optimized `7`
