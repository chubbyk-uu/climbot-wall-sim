...
| P2-06 联合盲测 | [mosaic_p206_blind_2026-08-30_summary.json](mosaic_p206_blind_2026-08-30_summary.json) | `3f422f5` 横 680 + 竖 660 = 1,340 帧；行驶矩形内零漏拍，绝对锚点 P95 1.67 mm；门限未冻结 |
...
- P2-06 的覆盖已闭合：`3f422f5` 联合盲测在行驶矩形内零漏拍，绝对锚点 P95 1.67 mm。
  门限仍未冻结，因为只有一组数据。判据口径见 [拼接计划](../docs/MOSAIC_PLAN.md)。
...
- P2-06 新任务的采集前预检把 feature 裁到行驶矩形再判断，与采集后检查器的口径不同；
