...
| P2-06 联合盲测 | [mosaic_p206_blind_2026-08-30b_summary.json](mosaic_p206_blind_2026-08-30b_summary.json) | `3f422f5` 采集 1,340 帧，拼接链 `7f8b875`、检查 `9c89dda`，均为干净树；巡检域由归档链哈希校验取得，域内零漏拍，绝对锚点 P95 1.67 mm；六阶段 provenance 与 5 条链接自校验通过；门限未冻结 |
...
- 巡检域外的 `439,116` 个未覆盖像素**不是拍不到**：逐像素分类显示全部落在可观测包络之内，
  真正无位姿可拍的是 `0` 个。它们被豁免只因为验收域这样定义，与够不着无关。
